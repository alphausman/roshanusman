...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO customized (name, email, phone, address, services,message)
VALUES ('$name','$email', '$phone', '$address', '$services', '$message')";

if ($conn->query($sql) === TRUE) {
	
	
	
    echo "<script type=\"text/javascript\">window.location.href = 'customized.php';</script>";
           exit;
} else {
...
<a href="http://www.ivhseniorcare.com/synapse/">Synapse Writing Campaign Participate & Win</a>
    ...
    <div class="row container-kamn">
        <img class="img-responsive img-whp" src="images/resource/Customized.jpg" alt="about1.jpeg"> 
    </div>
	<br>
			<br>
			<br>
        ...
        <div class="row">
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <fieldset>
                              <form name="contactform" method="post" action="customized.php">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group form-group-email">
                                        ...
                                        <input type="text" class="form-control" name="address" id="Orgnization" placeholder="Enter Your Orgnization">
                                    </div>
                                </div>
								<div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                     <label for="exampleFormControlInput1">services</label>
                                      <select name="services" class="form-control" id="exampleFormControlSelect1">
									            <option value="Selected">--Preferred Services--</option>
												<option value="Care Manager Services" "selected"="">Care Manager Services</option>
												<option value="Social Concierge" "selected"="">Social Concierge</option>
                               ...
                               <div class="col-md-12">
							     <div class="form-group form-group-message">
                                      <input type="submit"  onclick="alert('Form submit successfully click ok')" value="Submit" class="btn btn-primary" name="submit">
										<p id="demo"></p>
