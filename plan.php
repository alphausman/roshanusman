  			...
  			<div class="row">
  				<div class="col-md-4 col-xs-12">
  					<div class="social-linked">
  						<ul class="list-inline">
  							<li><a href="https://www.facebook.com/ivhseniorcare/"><i class="fa fa-facebook"></i></a></li>
  				...
  				<div class="col-md-5 col-xs-12">
  					<div class="welcm-ht text-center">
	  					<p class="ulockd-welcntxt">Welcome To Our<span class="text-thm1"> India Virtual Hospital </span></p>
						<a href="http://ivhseniorcare.com/images/Company_Profile/index.php">Media Doc</a>
  					</div>
			        				        ...
			        				        <div class="modal-body">
				        				      	<div class="row">
				        				      		<div class="col-sm-12 col-md-6 col-lg-5 text-center hvr-float-shadow">
				        						        <form class="ulockd-login-form" action="index.php">
...
<a href="http://www.ivhseniorcare.com/synapse/">Synapse Writing Campaign Participate & Win</a>
    ...
    <div class="row container-kamn">
        <img class="img-responsive img-whp" src="images/resource/hospital.jpg" alt="about1.jpeg"> 
    </div>
