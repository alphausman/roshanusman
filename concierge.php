...
<meta name="description" content="ivh Seniorcare is best home healthcare provider in India.Providing home healthcare services in Delhi-NCR,Bangalore,Haryana, Punjab & Mumbai.">
  <meta name="keywords" content="Cocierge">
<!-- css file -->
			    ...
			    <nav class="navbar navbar-default bootsnav menu-style1 light-blue col-md-12">
			        ...
			        <div class="container ulockd-pdng0">
			            ...
			            <div class="navbar-header">
							...
							<a class="navbar-brand wow fadeInDownBig office-logo logo_deactive text-align-logo" href="index.php" style="visibility: visible; animation-name: fadeInDownBig;"><img src="images/header-logo1.jpg" alt="Nursing Care in Chandigarh"></a>
			            </div>
...
<a href="http://www.ivhseniorcare.com/synapse/">Synapse Writing Campaign Participate & Win</a>
    ...
    <div class="row container-kamn">
        <img src="images/resource/cm3.jpg" class="blog-post" alt="Senior Care in Delhi" align="right" width="100%" height=""> 
    </div>
	<br>
			<br>
			<br>
...
<p>
Engaging and entertaining the elders is the biggest challenge. 
The trustworthy support of our <b>Care Managers</b> will fill the gap by accompanying your elders for various activities.
<p style="margin-left: 16px;"><span class="dotte_3">&#9830;</span>Pick up/Drop off</p>
<p style="margin-left: 16px;"><span class="dotte_3">&#9830;</span>Transportation and Logistics</p>
<p style="margin-left: 16px;"><span class="dotte_3">&#9830;</span>Packages for Yoga (asanas, relaxation excercies, pranayama)</p>
<p style="margin-left: 16px;"><span class="dotte_3">&#9830;</span>Packages for Ayurveda/Naturopathy treatments (stress and weight management, body detox and rejuvination )</p>
<p style="margin-left: 16px;"><span class="dotte_3">&#9830;</span>Heritage tours(Chaar dham yatra, Himkund sahib yatra, Vaishno devi and many more)</p>
<p style="margin-left: 16px;"><span class="dotte_3">&#9830;</span>Final Journey</p>

<p>Patients and their relatives can utilise this unique opportunity of exploring Indian culture and healing through natural methods.</p>
			 ...
			 <form action="http://templates.designorbital.com/baleen/contact.php" method="post" id="contact-form">
                        <div class="box">
                            ...
                            <fieldset>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group form-group-email">
                                        <label class="control-label" for="Orgnization">Address *</label>
                                        <input type="text" class="form-control" name="Orgnization" id="Orgnization" placeholder="Enter Your Orgnization">
                                    </div>
                                </div>
							...
							<p>* Concierge services are available only for our subscription clients</p>
                        </div>
                    </form>-->
